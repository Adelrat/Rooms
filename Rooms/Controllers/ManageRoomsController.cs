...
namespace Rooms.Controllers
{
    public class ManageRoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,answer,task")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,answer,task")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
