...
{
    public class ManageDoorController : Controller
    {
        private readonly DataContext _context;

        public ManageDoorController(DataContext context)
        {
#if !DEBUG //dirty hack to prevent access to admin page
            throw new Exception("You can manage object only from debug");
#endif   
            _context = context;
